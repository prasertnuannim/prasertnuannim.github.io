    ...
    <div className="max-w-[1280px] mx-auto" id="monitorMachine">
      <div className="flex space-x-3 md:space-x-10 sm:space-x-0">
        <div className="flex flex-col items-center">
          <motion.div
            ...
            className="relative"
          >
            <p className="text-white bg-blue-700 text-center h-[30px] w-[30px] rounded-md flex items-center justify-center md:text-2xl sm:mr-2 sm:text-sm">
              2
            </p>
      ...
      >
        <img
          ...
          alt=""
          aria-hidden="true"
          src="/images/beltonMonitorMachine/MonitorMachineState.png"
        />
      </motion.div>
