...
const LiIcon = ({ reference }: Props) => {
  ...
  return (
    <figure className="absolute left-0 stroke-darkt">
      <svg className="-rotate-90 md:w-[60px] xs:w-[40px] xs:h-[40px]" width="75" height="75" viewBox="0 0 100 100">
        <circle
          cx="75"
          cy="50"
          r="20"
